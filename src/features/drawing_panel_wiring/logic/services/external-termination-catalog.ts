  ...
  return terminationIds
    .flatMap((terminationId): ExternalTerminationCatalogRow[] => {
      ...
      return [{
        ...
        mappingMode: termination.mappingMode,
        mappingId: termination.mappingId,
        inferredTarget: termination.inferredTarget,
        target: termination.target,
        sourceAssetId: termination.sourceAssetId,
        sourceAssetTag: termination.sourceAssetTag,
        targetAssetId,
