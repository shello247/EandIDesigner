...
Current blocker: expired dependency-audit exceptions and additional unallowlisted high findings on the baseline. Need authorization for narrowly scoped dependency-security remediation; no policy/dependency changes yet.
